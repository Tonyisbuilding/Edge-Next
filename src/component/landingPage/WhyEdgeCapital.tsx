    ...
    <>
      <div className=" bg-[#192227] py-[1rem] md:rounded-[2rem] rounded-[1rem]">
        <div className=" p-[1rem]">
          <h1 className=" text-[#FFFFFF] font-semibold md:text-[48px] text-[30px] montserrat md:px-[1rem]">
            Why Edge Capital?
          </h1>
          <p className=" md:text-[17.45px] font-normal text-[#FFFFFF] my-5 lg:w-[50rem] montserrat md:px-[1rem]">
        ...
        <div className=" grid  lg:grid-cols-3 md:grid-cols-2 md:p-5 ">
          {whyEdgeCapitalData.map((data) => {
            return (
              <div key={data.id} className=" bg-[#F9A600] m-5 rounded-2xl">
                <div
