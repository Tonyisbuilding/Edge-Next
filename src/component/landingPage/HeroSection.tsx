...
const HeroSection = () => {
  return (
    <>
      <section className=" bg-[#EEF4F5] lg:flex px-[2rem] gap-[3rem] pt-[1rem]">
        <div className=" flex items-center">
          <div>
            <h1 className=" md:text-[55.19px] text-[30px] font-black text-black montserrat
             lg:w-[25rem] lg:mt-[10rem]">
              Investing with an Edge
            </h1>
            <p className=" text-[18px] text-black font-semibold py-[1rem]">
            ...
            <div className=" md:flex md:gap-[2rem] gap-2 py-[2rem]">
              <div className=" flex justify-center items-center mt-[1rem]">
                <button className=" bg-[#007272] text-white py-2 md:px-5 px-[5rem] rounded-3xl hover:cursor-pointer">
                Get started Now
                </button>
              </div>
              <div className=" flex justify-center items-center mt-[1rem]">
                <button className=" bg-white text-[#007272] py-2 md:px-5 px-[5rem] rounded-3xl 
