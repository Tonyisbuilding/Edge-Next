  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="p-7 border-b border-gray-100 bg-gradient-to-r from-[rgba(32,106,124,0.08)] to-transparent flex justify-between items-center">
              <div className="flex items-center gap-3">
                <div className="bg-white rounded-full w-10 h-10 flex items-center justify-center shadow-sm border border-gray-100">
                  <svg className="w-9 h-6" viewBox="0 0 36 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2 22 L8 14 L14 16 L20 10 L26 6 L34 4" stroke="#206A7C" strokeWidth="2" strokeLinecap="round" fill="none" />
                    <path d="M2 22 L8 14 L14 16 L20 10 L26 6 L34 4 L34 22 L2 22" fill="rgba(32, 106, 124, 0.1)" />
                  </svg>
                </div>
                <span className="text-lg font-semibold text-[#206A7C]">February</span>
              </div>
            ...
            <div className="p-7">
              ...
              <ul className="mb-7">
                {card.metrics.map((metric, i) => (
                  <li key={i} className={`flex justify-between items-center pb-3 ${i === card.metrics.length - 1 ? '' : 'border-b border-gray-100'}`}>
      ...
      <motion.div
        ...
        className="bg-orange-500 text-white p-9 rounded-[20px] shadow-md relative overflow-hidden"
      >
