      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="hidden md:flex">
          ...
          <div className="w-1/2 pr-8">
            <div className="mb-8">
              <h2 className="text-4xl font-bold text-gray-800">How to Get Started</h2>
              <p className="text-xl text-gray-600 mt-2">Refer, earn and impact in three simple steps</p>
            </div>
            
            <div className="flex items-center">
              <button 
                onClick={handlePrev}
                className="h-12 w-12 rounded-full bg-white flex items-center justify-center shadow-md mr-4 focus:outline-none focus:ring-2 focus:ring-green-500"
              ...
              <button 
                onClick={handleNext}
                className="h-12 w-12 rounded-full bg-white flex items-center justify-center shadow-md focus:outline-none focus:ring-2 focus:ring-green-500"
        ...
        <div className="md:hidden">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center mt-4">
              <button 
                onClick={handlePrev}
                className="h-10 w-10 rounded-full bg-white flex items-center justify-center shadow-md mr-4 focus:outline-none focus:ring-2 focus:ring-green-500"
                aria-label="Previous step"
              >
              ...
              <button 
                onClick={handleNext}
                className="h-10 w-10 rounded-full bg-white flex items-center justify-center shadow-md focus:outline-none focus:ring-2 focus:ring-green-500"
                aria-label="Next step"
              >
