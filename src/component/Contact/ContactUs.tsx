  ...
  return (
    <section className="max-w-6xl mx-auto my-12 px-4 md:px-0">
      <div className="flex flex-col md:flex-row rounded-lg overflow-hidden shadow-lg">
        ...
        <motion.div 
          className="bg-teal-600 text-white p-8 md:w-1/2"
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <motion.div className="flex items-center" variants={itemVariants}>
              ...
              <div>
                ...
                <p className="font-bold">123 Business Ave, Suits 100, Netherland</p>
              </div>
            </motion.div>
          ...
          <motion.div 
            ...
            variants={itemVariants}
          >
            <a href="#" className="w-10 h-10 bg-teal-500 rounded-full flex items-center justify-center hover:bg-teal-400 transition-colors">
              <FaFacebookF />
            </a>
            <a href="#" className="w-10 h-10 bg-teal-500 rounded-full flex items-center justify-center hover:bg-teal-400 transition-colors">
              <FaLinkedinIn />
